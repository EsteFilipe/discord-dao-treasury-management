...
(function (Release_OrderBy) {
    ...
    Release_OrderBy["CurveLiquidityEursAdapter"] = "curveLiquidityEursAdapter";
...
exports.AssetsDocument = (0, graphql_tag_1["default"])(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n    query assets {\n  assets(first: 1000, orderBy: symbol, orderDirection: asc) {\n    id\n    name\n    symbol\n    decimals\n    type\n    derivativeType\n    releases {\n      id\n    }\n    price {\n      price\n      timestamp\n    }\n    underlyingAsset {\n      id\n      symbol\n      name\n      decimals\n    }\n    uniswapV2PoolAssetDetails {\n      token0 {\n        id\n        symbol\n        decimals\n      }\n      token1 {\n        id\n        symbol\n        decimals\n      }\n    }\n  }\n}\n    "], ["\n    query assets {\n  assets(first: 1000, orderBy: symbol, orderDirection: asc) {\n    id\n    name\n    symbol\n    decimals\n    type\n    derivativeType\n    releases {\n      id\n    }\n    price {\n      price\n      timestamp\n    }\n    underlyingAsset {\n      id\n      symbol\n      name\n      decimals\n    }\n    uniswapV2PoolAssetDetails {\n      token0 {\n        id\n        symbol\n        decimals\n      }\n      token1 {\n        id\n        symbol\n        decimals\n      }\n    }\n  }\n}\n    "])));
exports.CurrentReleaseContractsDocument = (0, graphql_tag_1["default"])(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n    query currentReleaseContracts {\n  network(id: \"ENZYME\") {\n    currentRelease {\n      adapterBlacklist\n      adapterWhitelist\n      aggregatedDerivativePriceFeed\n      assetBlacklist\n      assetWhitelist\n      buySharesCallerWhitelist\n      chaiAdapter\n      chaiIntegratee\n      chainlinkPriceFeed\n      compoundAdapter\n      comptrollerLib\n      dispatcher\n      entranceRateBurnFee\n      entranceRateDirectFee\n      feeManager\n      fundActionsWrapper\n      fundDeployer\n      guaranteedRedemption\n      integrationManager\n      investorWhitelist\n      kyberAdapter\n      kyberIntegratee\n      managementFee\n      maxConcentration\n      minMaxInvestment\n      paraSwapAdapter\n      performanceFee\n      policyManager\n      synthetixAdapter\n      synthetixAddressResolver\n      synthetixDelegateApprovals\n      synthetixIntegratee\n      trackedAssetsAdapter\n      uniswapV2Adapter\n      uniswapV2Integratee\n      valueInterpreter\n      vaultLib\n      wethToken\n      zeroExV2Adapter\n    }\n  }\n}\n    "], ["\n    query currentReleaseContracts {\n  network(id: \"ENZYME\") {\n    currentRelease {\n      adapterBlacklist\n      adapterWhitelist\n      aggregatedDerivativePriceFeed\n      assetBlacklist\n      assetWhitelist\n      buySharesCallerWhitelist\n      chaiAdapter\n      chaiIntegratee\n      chainlinkPriceFeed\n      compoundAdapter\n      comptrollerLib\n      dispatcher\n      entranceRateBurnFee\n      entranceRateDirectFee\n      feeManager\n      fundActionsWrapper\n      fundDeployer\n      guaranteedRedemption\n      integrationManager\n      investorWhitelist\n      kyberAdapter\n      kyberIntegratee\n      managementFee\n      maxConcentration\n      minMaxInvestment\n      paraSwapAdapter\n      performanceFee\n      policyManager\n      synthetixAdapter\n      synthetixAddressResolver\n      synthetixDelegateApprovals\n      synthetixIntegratee\n      trackedAssetsAdapter\n      uniswapV2Adapter\n      uniswapV2Integratee\n      valueInterpreter\n      vaultLib\n      wethToken\n      zeroExV2Adapter\n    }\n  }\n}\n    "])));
exports.VaultDocument = (0, graphql_tag_1["default"])(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n    query vault($id: ID!) {\n  fund(id: $id) {\n    release {\n      id\n    }\n    accessor {\n      id\n    }\n  }\n}\n    "], ["\n    query vault($id: ID!) {\n  fund(id: $id) {\n    release {\n      id\n    }\n    accessor {\n      id\n    }\n  }\n}\n    "])));
...
function getSdk(client, withWrapper) {
    ...
    return {
        assets: function (variables, requestHeaders) {
            return withWrapper(function (wrappedRequestHeaders) { return client.request(exports.AssetsDocument, variables, __assign(__assign({}, requestHeaders), wrappedRequestHeaders)); }, 'assets');
        },
        currentReleaseContracts: function (variables, requestHeaders) {
            return withWrapper(function (wrappedRequestHeaders) { return client.request(exports.CurrentReleaseContractsDocument, variables, __assign(__assign({}, requestHeaders), wrappedRequestHeaders)); }, 'currentReleaseContracts');
        },
        vault: function (variables, requestHeaders) {
            return withWrapper(function (wrappedRequestHeaders) { return client.request(exports.VaultDocument, variables, __assign(__assign({}, requestHeaders), wrappedRequestHeaders)); }, 'vault');
        }
    };
}
