...
function getSdk(client, withWrapper) {
    ...
    return {
        assets: function (variables, requestHeaders) {
            return withWrapper(function () { return client.request((0, graphql_1.print)(exports.AssetsDocument), variables, requestHeaders); });
        },
        currentReleaseContracts: function (variables, requestHeaders) {
            return withWrapper(function () { return client.request((0, graphql_1.print)(exports.CurrentReleaseContractsDocument), variables, requestHeaders); });
        },
        vault: function (variables, requestHeaders) {
            return withWrapper(function () { return client.request((0, graphql_1.print)(exports.VaultDocument), variables, requestHeaders); });
        }
    };
}
