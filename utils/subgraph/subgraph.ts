...
export type PolicyDisabledForFundEvent = EventInterface & ComptrollerEventInterface & {
...
export type PolicyEnabledForFundEvent = EventInterface & ComptrollerEventInterface & {
...
export type Release = {
  ...
  curveLiquidityEursAdapter: Scalars['String'];
...
export type Release_Filter = {
  ...
  curveLiquidityEursAdapter?: Maybe<Scalars['String']>;
  curveLiquidityEursAdapter_not?: Maybe<Scalars['String']>;
  curveLiquidityEursAdapter_gt?: Maybe<Scalars['String']>;
  curveLiquidityEursAdapter_lt?: Maybe<Scalars['String']>;
  curveLiquidityEursAdapter_gte?: Maybe<Scalars['String']>;
  curveLiquidityEursAdapter_lte?: Maybe<Scalars['String']>;
  curveLiquidityEursAdapter_in?: Maybe<Array<Scalars['String']>>;
  curveLiquidityEursAdapter_not_in?: Maybe<Array<Scalars['String']>>;
  curveLiquidityEursAdapter_contains?: Maybe<Scalars['String']>;
  curveLiquidityEursAdapter_not_contains?: Maybe<Scalars['String']>;
  curveLiquidityEursAdapter_starts_with?: Maybe<Scalars['String']>;
  curveLiquidityEursAdapter_not_starts_with?: Maybe<Scalars['String']>;
  curveLiquidityEursAdapter_ends_with?: Maybe<Scalars['String']>;
  curveLiquidityEursAdapter_not_ends_with?: Maybe<Scalars['String']>;
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    assets(variables?: AssetsQueryVariables, requestHeaders?: Headers): Promise<AssetsQuery> {
      return withWrapper(() => client.request<AssetsQuery>(print(AssetsDocument), variables, requestHeaders));
    },
    currentReleaseContracts(variables?: CurrentReleaseContractsQueryVariables, requestHeaders?: Headers): Promise<CurrentReleaseContractsQuery> {
    ...
    vault(variables: VaultQueryVariables, requestHeaders?: Headers): Promise<VaultQuery> {
      return withWrapper(() => client.request<VaultQuery>(print(VaultDocument), variables, requestHeaders));
    }
  };
}
